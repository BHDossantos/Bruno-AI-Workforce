          ...
          <tbody>
            {(data || []).map((l) => (
              <tr key={l.id} className="border-t border-gray-100">
                ...
                <td className="td"><Link href={`/leads/detail?id=${l.id}`} className="font-medium text-brand-dark hover:underline">{l.company_name || l.owner_name || "View"}</Link><div className="text-xs text-gray-400">{l.owner_name}</div></td>
                <td className="td">
